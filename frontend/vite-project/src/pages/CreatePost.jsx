       ...
       <Navbar />
          ...
          <div className="flex flex-col">
            <div className="flex items-center space-x-4 md:space-x-8">
                ...
                <div onClick={addCategory} className='bg-black text-white px-4 py-2 font-semibold cursor-pointer  hover:bg-gray-500 hover:text-black'>Add</div>
            </div>
            ...
            <button onClick={handleCreate} className='bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg hover:bg-gray-500 hover:text-black'>Create</button>
            </form>
          </div>
       <Footer/>
    </div>

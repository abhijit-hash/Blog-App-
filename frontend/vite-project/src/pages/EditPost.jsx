    ...
    <div>
       <Navbar />
          ...
          <div className="flex flex-col">
            ...
            <button onClick={handleUpdate} className='bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg hover:bg-gray-500 hover:text-black'>Update</button>
            </form>
          </div>
       <Footer/>
    </div>
